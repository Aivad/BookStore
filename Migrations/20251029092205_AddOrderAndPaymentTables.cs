...
namespace BookStore.Migrations
{
    ...
    public partial class AddOrderAndPaymentTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Create OrderItems table (from ItemOrder model)
            migrationBuilder.CreateTable(
                name: "OrderItems",
                columns: table => new
                {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropIndex(name: "IX_OrderItems_BookId", table: "OrderItems");
            migrationBuilder.DropIndex(name: "IX_Orders_UserId", table: "Orders");
            migrationBuilder.DropIndex(name: "IX_Orders_PaymentMethodId", table: "Orders");
